...
export const SUGGESTED_BASES: ChainTokenList = {
  ...
  [ChainId.BSC]: [bscTokens.usdt, bscTokens.btcb],
...
export const LIMIT_ORDERS_DOCS_URL = 'https://docs.decentralbros.finance/products/decentralbros-exchange/limit-orders'
