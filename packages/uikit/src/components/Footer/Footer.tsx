  ...
  return (
    ...
    >
      <Flex flexDirection="column" width={["100%", null, "1200px;"]}>
        <StyledIconMobileContainer>
          <Image src="/logo.webp" alt="dbro swap" height={50} width={50} />
        </StyledIconMobileContainer>
        <Flex
          order={[2, null, 1]}
        ...
        >
          ...
          {/* <Box display={["none", null, "block"]}>
            {isXl ? (
              <Image src="/logo.png" alt="dbro swap" height={50} width={50} />
            ) : (
              <Image src="/tree-left.png" alt="dbro swap" height={50} width={50} />
            )}
          </Box> */}
        </Flex>
