...
import { useProxyVeCakeBalanceOfAtTime } from 'views/StakingDBRO/hooks/useProxyVeCakeBalanceOfAtTime'
import { useTargetUnlockTime } from 'views/StakingDBRO/hooks/useTargetUnlockTime'
import { useCakeLockStatus, useVeCakeUserInfo } from 'views/StakingDBRO/hooks/useVeCakeUserInfo'
...
export const PreviewOfVeCakeSnapShotTime: React.FC<React.PropsWithChildren<PreviewOfVeCakeSnapShotTimeProps>> = ({
  ...
  const unlockTimestamp = useTargetUnlockTime(
    ...
    cakeLockExpired || status === CakeLockStatus.NotLocked || !cakeLocked ? undefined : Number(cakeUnlockTime),
  )
