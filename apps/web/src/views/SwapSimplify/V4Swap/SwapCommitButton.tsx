...
const SwapCommitButtonInner = memo(function SwapCommitButtonInner({
  ...
  const parsedAmounts = useParsedAmounts(undefined, currencyBalances, false)
  const parsedIndependentFieldAmount = parsedAmounts[independentField]
  const swapInputError = useSwapInputError(undefined, currencyBalances)
  ...
  const slippageAdjustedAmounts = useSlippageAdjustedAmounts(undefined)
